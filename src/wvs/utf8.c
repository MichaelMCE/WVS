...
static int utf8_wcstombs (ubyte *des, size_t des_n, wchar_t *wc, size_t wc_n)
{
...
/* function is also found within libmylcdstatic.a so disabled when building the dll*/
#ifndef BUILDING_DLL
int UTF8ToUTF32a (const unsigned char *buffer, unsigned int *pwc)
{
...
int UTF8ToUTF32b (const unsigned char *buffer, unsigned int *pwc)
{
...
static int utf8_to_utf16 (char *src, size_t srcLen, wchar_t *des)
{
