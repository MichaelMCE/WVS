...
!define PRODUCT_VERSION "0.30.14 for AIMP2"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\..\aimp2.exe"
...
OutFile "wvs_03014-aimp-setup.exe"
InstallDir "$PROGRAMFILES\Aimp2\Plugins"
...
loop:
  ...
  MessageBox MB_RETRYCANCEL|MB_ICONSTOP 'Aimp must be closed during this installation.$\r$\n Close Aimp now, or press "Retry" to automatically close Aimp and continue or press "Cancel" to cancel the installation entirely.' IDCANCEL BailOut
  push "aimp2.exe"
...
;  SetOutPath "$INSTDIR\wvs\CopyToAimpPlugins"
   ...
   File "t:\wvssetup\wvs\CopyToAimpPlugins\gen_wvs.dll"
