...
#define libmylcdVERSIONmi	4
#define libmylcdVERSION		"0.80.4"
...
#define PF_HORIZONTALRTL	0x4000000	// render from right to left. Intended for East Asian (CJK) languages.
...
MYLCD_EXPORT int
lLoadImageEx (TFRAME *frame, const wchar_t *filename, const int x_offset, const int y_offset);
...
MYLCD_EXPORT TFRAME *
lNewStringList (THWD *hw, const int lfrm_bpp, const int flags, const int font, const UTF32 *glist, const int gtotal);
...
MYLCD_EXPORT int
lDrawPolyLineTo (TFRAME *frame, T2POINT *lppt, int tnodes, const int colour);
...
MYLCD_EXPORT int
lDrawArc (TFRAME *frame, int x, int y, int r1, int r2, float a1, float a2, const int colour);

MYLCD_EXPORT int
lDrawEnclosedArc (TFRAME *frame, int x, int y, int r1, int r2, float a1, float a2, const int colour);
...
MYLCD_EXPORT int
lConvolve2D (TFRAME *in, TFRAME *out, const int dataSizeX, const int dataSizeY, 
               float *const kernel, const int kernelSizeX, const int kernelSizeY);

MYLCD_EXPORT int
lConvolve2DSeparable (TFRAME *in, TFRAME *out, const int width, const int height, 
