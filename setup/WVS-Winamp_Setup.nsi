...
!define PRODUCT_VERSION "0.30.14 for Winamp"
...
OutFile "wvs_03014-winamp-setup.exe"
...
loop:
  ...
  MessageBox MB_RETRYCANCEL|MB_ICONSTOP 'Winamp must be closed during this installation.$\r$\n Close Winamp now, or press "Retry" to automatically close Winamp and continue or press "Cancel" to cancel the installation entirely.' IDCANCEL BailOut
  push "winamp.exe"
