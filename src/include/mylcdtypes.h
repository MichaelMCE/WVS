...
typedef struct{
	TLPRINTREGION *loc;
	void (*copy) (TLPRINTREGION *loc);	// glyph render method
...
struct TWFONT {
	...
	int LineSpace;		//number of vertical pixels to skip between wrapped lines
	int spaceSpacing;	// pixels to add/subtract from zero width glyphs (eg; ' '). is always 0 unless set.
